...
#    using topology data from: cumulus-ansible-intermediate-mlag-j2.dot
...
REPOSITORY="https://github.com/CumulusNetworks/cumulus-ansible-intermediate-mlag-j2"
REPONAME="cumulus-ansible-intermediate-mlag-j2"
