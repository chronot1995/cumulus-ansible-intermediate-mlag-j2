## cumulus-ansible-intermediate-mlag-j2
...
![Network Diagram](https://github.com/chronot1995/cumulus-ansible-intermediate-mlag-j2/blob/master/documentation/cumulus-ansible-intermediate-mlag-j2 .png)
...
```
    git clone https://github.com/chronot1995/cumulus-ansible-intermediate-mlag-j2/
```
...
```
    cumulus-ansible-intermediate-mlag-j2/automation
```
...
```
     ./topology_converter.py cumulus-ansible-intermediate-mlag-j2.dot -c --provider=virtualbox
     ./topology_converter.py cumulus-ansible-intermediate-mlag-j2.dot -c --provider=libvirt
```
